    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(AbpSolutionConsts.DbTablePrefix + "Books", AbpSolutionConsts.DbSchema);
        ...
        {
            b.ToTable(AbpSolutionConsts.DbTablePrefix + "Authors", AbpSolutionConsts.DbSchema);
