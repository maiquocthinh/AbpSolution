...
namespace AbpSolution.Blazor.Client.Pages
{
    public partial class Authors
    {
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreateAuthor = await AuthorizationService
                .IsGrantedAsync(AbpSolutionPermissions.Authors.Create);

            CanEditAuthor = await AuthorizationService
                .IsGrantedAsync(AbpSolutionPermissions.Authors.Edit);

            CanDeleteAuthor = await AuthorizationService
                .IsGrantedAsync(AbpSolutionPermissions.Authors.Delete);
        }
